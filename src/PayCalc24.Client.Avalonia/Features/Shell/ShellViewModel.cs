...
public sealed class ShellViewModel : ViewModelBase
{
    ...
    public string ClearLabel => Local("Clear", "Xóa lọc");
    public string RefreshLabel => Local("Refresh", "Làm mới");
    public string PreviewLabel => Local("Preview", "Xem trước");
    public string WorkflowHeading => Local("Workflow", "Quy trình");
    public string AttentionHeading => Local("Attention", "Cần chú ý");
    public string BlockingSummary => Local("0 BLOCKING", "0 CHẶN");
    public string WarningSummary => Local("1 WARNING", "1 CẢNH BÁO");
    public string InformationSummary => Local("1 INFORMATION", "1 THÔNG TIN");
    public string SubjectDetailsHeading => Local("Subject details", "Chi tiết nhân sự");
    public string NoBlockingDiagnostics => Local("No blocking diagnostics", "Không có chẩn đoán chặn");
    public string ImmutableExplanationHeading => Local("Immutable explanation", "Giải trình bất biến");
    public string ExplanationHierarchy => Local("Component → Formula/Method → Inputs → Source facts → Result → Funding", "Thành phần → Công thức/Phương pháp → Đầu vào → Dữ liệu nguồn → Kết quả → Nguồn quỹ");
    public string ExplainPinnedContext => Local("Snapshot 1 · DEMO-RUN-001 · no recalculation", "Bản chụp 1 · DEMO-RUN-001 · không tính lại");
    public string ImmutableHistoryHeading => Local("Immutable history", "Lịch sử bất biến");
    public string ReportPinnedContext => Local("Company DEMO · Period 2026-07 · Revision 1 · Run DEMO-RUN-001", "Công ty DEMO · Kỳ 2026-07 · Phiên bản 1 · Lượt DEMO-RUN-001");
    public string ExploreLabel => Local("Explore", "Khám phá");
    public string ActionsLabel => Local("Actions", "Thao tác");
    public string SourcesLabel => Local("Sources", "Nguồn dữ liệu");
    public string CurrentWorkspaceLabel => Local("Current workspace", "Không gian hiện tại");
    public string ProcessLabel => Local("Process", "Xử lý");
    public string DiagnosticsLabel => Local("Diagnostics", "Chẩn đoán");
    public string LifecycleLabel => Local("Lifecycle", "Vòng đời");
    public string OutputLabel => Local("Output", "Đầu ra");
    public string OpenValidationLabel => Local("Open Validation", "Mở kiểm tra");
    public string OpenExplainLabel => Local("Open Explain", "Mở giải trình");
    public string ValidateActionLabel => Local("Validate", "Kiểm tra");
    public string CommitLabel => Local("Commit", "Ghi nhận");
    public string RunLabel => Local("Run", "Chạy");
    public string ErrorsLabel => Local("Errors", "Lỗi");
    public string WarningsLabel => Local("Warnings", "Cảnh báo");
    public string AllLabel => Local("All", "Tất cả");
    public string SubmitLabel => Local("Submit", "Gửi duyệt");
    public string StartReviewLabel => Local("Start Review", "Bắt đầu rà soát");
    public string ApproveLabel => Local("Approve", "Phê duyệt");
    public string RejectLabel => Local("Reject", "Từ chối");
    public string LockLabel => Local("Lock", "Khóa");
    public string GenerateLabel => Local("Generate", "Tạo");
    public string ExportLabel => Local("Export", "Xuất");
