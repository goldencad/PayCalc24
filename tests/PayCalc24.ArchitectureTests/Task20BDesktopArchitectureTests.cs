...
public sealed class Task20BDesktopArchitectureTests
{
    ...
    public void MainWindowUsesActiproRibbonBackstageAndStructuredTemplates()
    {
        ...
        var application = File.ReadAllText(Path.Combine(Root, "src", "PayCalc24.Client.Avalonia", "App.axaml"));
        var codeBehind = File.ReadAllText(Path.Combine(Root, "src", "PayCalc24.Client.Avalonia", "MainWindow.axaml.cs"));
