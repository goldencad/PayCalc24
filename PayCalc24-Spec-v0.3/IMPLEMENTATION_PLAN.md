# PayCalc24 — Implementation Plan v0.3
...
## Task 02 — Company Context, Current User, Correlation & Audit Foundation
**Depends on:** 01  
Implement TS24 Core abstractions, company isolation, current user, correlation/idempotency and audit writer contracts.
